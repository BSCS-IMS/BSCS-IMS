...
export default function ResellersPage() {
  ...
  // Search filter
  const filtered = resellers.filter((r) => r.businessName?.toLowerCase().includes(search.toLowerCase()))
                ...
                return (
                  <TableRow key={row.id} hover>
                    ...
                    <TableCell sx={{ display: 'flex', alignItems: 'center', gap: 1 }}>
                      <Switch checked={row.status === 'active'} onChange={() => handleToggleStatus(row)} size='small' />
